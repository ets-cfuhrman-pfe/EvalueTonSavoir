// GiftCheatSheetV2.tsx
import React, { useState } from 'react';
import { Button } from '@mui/material';
import ExpandLessIcon from '@mui/icons-material/ExpandLess';
import ExpandMoreIcon from '@mui/icons-material/ExpandMore';

const GiftCheatSheetV2: React.FC = () => {
    ...
    return (
        <div className="gift-cheat-sheet p-3">
            {/* Cheat Sheet Header with Collapse Toggle */}
            <div className="d-flex justify-content-between align-items-center mb-3">
                <h2 className="h3 text-dark mb-0">Informations pratiques sur l&apos;éditeur</h2>
                <Button
                    variant="text"
                    size="large"
            ...
            {/* Collapsible Cheat Sheet Content */}
            {!isCollapsed && (
                <>
                    <p className="mb-4">
            ...
            <div className="question-type mb-4">
                <h4 className="h4 mb-3">1. Questions Vrai/Faux</h4>
                <pre className="bg-light p-3 rounded border">
                    <code className="selectable-text text-dark">
                        {QuestionVraiFaux}
                    </code>
                </pre>
                <button
            ...
            <div className="question-type mb-4">
                <h4 className="h4 mb-3">2. Questions à choix multiple</h4>
                <pre className="bg-light p-3 rounded border">
                    <code className="question-code-block selectable-text text-dark">
                        {
                            QuestionChoixMul
                        }
                    </code>
            ...
            <div className="question-type mb-4">
                <h4 className="h4 mb-3">3. Questions à choix multiple avec plusieurs réponses</h4>
                <pre className="bg-light p-3 rounded border">
                    <code className="question-code-block selectable-text text-dark">
                        {
            ...
            <div className="question-type mb-4">
                <h4 className="h4 mb-3">4. Questions à réponse courte</h4>
                <pre className="bg-light p-3 rounded border">
                    <code className="question-code-block selectable-text text-dark">
                        {QuestionCourte}
                    </code>
            ...
            <div className="question-type mb-4">
                <h4 className="h4 mb-3"> 5. Questions numériques </h4>
                <pre className="bg-light p-3 rounded border">
                    <code className="question-code-block selectable-text text-dark">
                        {
                            QuestionNum
            ...
            <div className="question-type mb-4">
                <h4 className="h4 mb-3"> 6. Paramètres optionnels </h4>
                <pre className="bg-light p-3 rounded border">
                    <code className="question-code-block selectable-text text-dark">
                        {'::Titre:: '}
                        <span className="code-comment selectable-text text-success">
            ...
            <div className="question-type mb-4">
                <h4 className="h4 mb-3"> 7. Caractères spéciaux </h4>
                <p>
            ...
            <div className="question-type mb-4">
                <h4 className="h4 mb-3"> 8. LaTeX et Markdown</h4>
                <p>
                ...
                <pre className="bg-light p-3 rounded border">
                    <code className="question-code-block selectable-text text-dark">{'$$x\\= \\frac\\{y^2\\}\\{4\\}$$'}</code>
                    <code className="question-code-block selectable-text text-dark">{'\n$x\\= \\frac\\{y^2\\}\\{4\\}$'}</code>
                </pre>
                <p>Exemple de texte Markdown:</p>
                <pre className="bg-light p-3 rounded border">
                    <code className="question-code-block selectable-text text-dark">{'[markdown]Grâce à la balise markdown, Il est possible d\'insérer du texte *italique*, **gras**, du `code` et bien plus.'}</code>
                </pre>
            </div>

            <div className="question-type mb-4" id="images-section">
                <h4 className="h4 mb-3"> 9. Images </h4>
                ...
                <pre className="bg-light p-3 rounded border">
                    <code className="question-code-block text-dark">
                        {'!['}
                        <span className="code-comment text-success">{`text alternatif`}</span>
                        {']('}
                        <span className="code-comment text-success">{`URL-de-l'image`}</span>
                        {' "'}
                        <span className="code-comment text-success">{`texte de l'infobulle`}</span>
                        {'")'}
                    </code>
                </pre>
            ...
            <div className="question-type mb-4">
                <h4 className="h4 mb-3"> 10. Informations supplémentaires </h4>
                <p>
                ...
                <a href="https://ethan-ou.github.io/vscode-gift-docs/docs/questions" className="text-decoration-none">
...
export default GiftCheatSheetV2;